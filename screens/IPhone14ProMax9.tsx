...
const IPhone14ProMax9 = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.iphone14ProMax9}>
      <Text style={[styles.encanadores, styles.timeFlexBox]}>Encanadores</Text>
      <View style={[styles.iphone14ProMax9Child, styles.cardapio11Layout1]} />
      <Pressable
      ...
      <View style={[styles.iphone14ProMax9Item, styles.iphone14Layout]} />
      <Pressable
      ...
      <View style={[styles.iphone14ProMax9Inner, styles.iphone14Layout]} />
      <Pressable
      ...
      <View
        style={[styles.iphone14ProMax9Child1, styles.iphone14ChildBorder]}
      />
      <Pressable
      ...
      <View
        style={[styles.iphone14ProMax9Child2, styles.iphone14ChildLayout]}
      />
      <View
        style={[styles.iphone14ProMax9Child3, styles.iphone14ChildLayout]}
      />
...
const styles = StyleSheet.create({
  ...
  iphone14ProMax9Child2: {
    top: -22,
    backgroundColor: Color.colorMidnightblue,
  },
  iphone14ProMax9Child3: {
    top: -29,
...
export default IPhone14ProMax9;
