...
const IPhone14ProMax8 = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.iphone14ProMax8}>
      <Text style={[styles.pedreiros, styles.timeFlexBox]}>{`Pedreiros
`}</Text>
      <View style={[styles.iphone14ProMax8Child, styles.iphone14Layout]} />
      <Pressable
      ...
      <View style={[styles.iphone14ProMax8Item, styles.iphone14Layout]} />
      <Pressable
      ...
      <View style={[styles.iphone14ProMax8Inner, styles.iphone14Layout]} />
      <Pressable
      ...
      <View style={[styles.rectangleView, styles.cardapio11Layout1]} />
      <Pressable
      ...
      <View
        style={[styles.iphone14ProMax8Child1, styles.rectangleViewBorder]}
      />
      <Pressable
      ...
      <View
        style={[styles.iphone14ProMax8Child2, styles.iphone14ChildLayout]}
      />
      <View
        style={[styles.iphone14ProMax8Child3, styles.iphone14ChildLayout]}
      />
...
const styles = StyleSheet.create({
  ...
  iphone14ProMax8Child2: {
    top: -22,
    backgroundColor: Color.colorMidnightblue,
  },
  iphone14ProMax8Child3: {
    top: -29,
...
export default IPhone14ProMax8;
