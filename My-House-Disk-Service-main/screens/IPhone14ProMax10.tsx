...
const IPhone14ProMax10 = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.iphone14ProMax10}>
      <Text style={[styles.eletricistas, styles.timeFlexBox]}>
        Eletricistas
      </Text>
      <View style={[styles.iphone14ProMax10Child, styles.cardapio11Layout1]} />
      <Pressable
      ...
      <View style={[styles.iphone14ProMax10Item, styles.iphone14Layout]} />
      <Pressable
      ...
      <View style={[styles.iphone14ProMax10Inner, styles.iphone14Layout]} />
      <Pressable
      ...
      <View
        style={[styles.iphone14ProMax10Child1, styles.iphone14ChildBorder]}
      />
      <Pressable
      ...
      <View
        style={[styles.iphone14ProMax10Child2, styles.iphone14ChildLayout]}
      />
      <View
        style={[styles.iphone14ProMax10Child3, styles.iphone14ChildLayout]}
      />
...
const styles = StyleSheet.create({
  ...
  iphone14ProMax10Child2: {
    top: -22,
    backgroundColor: Color.colorMidnightblue,
  },
  iphone14ProMax10Child3: {
    top: -29,
...
export default IPhone14ProMax10;
