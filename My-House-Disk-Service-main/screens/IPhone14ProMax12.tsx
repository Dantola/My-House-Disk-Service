...
const IPhone14ProMax12 = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.iphone14ProMax12}>
      <Text style={[styles.pintor, styles.timeFlexBox]}>{`Pintor
`}</Text>
      <View style={[styles.iphone14ProMax12Child, styles.cardapio11Layout1]} />
      <Pressable
      ...
      <View style={[styles.iphone14ProMax12Item, styles.iphone14Layout]} />
      <Pressable
      ...
      <View style={[styles.iphone14ProMax12Inner, styles.iphone14Layout]} />
      <Pressable
      ...
      <View
        style={[styles.iphone14ProMax12Child1, styles.iphone14ChildBorder]}
      />
      <Pressable
      ...
      <View
        style={[styles.iphone14ProMax12Child2, styles.iphone14ChildLayout]}
      />
      <View
        style={[styles.iphone14ProMax12Child3, styles.iphone14ChildLayout]}
      />
...
const styles = StyleSheet.create({
  ...
  iphone14ProMax12Child2: {
    top: -22,
    backgroundColor: Color.colorMidnightblue,
  },
  iphone14ProMax12Child3: {
    top: -29,
...
export default IPhone14ProMax12;
